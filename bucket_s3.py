...
def aws_upload(data: Dict):
    database = aws_lib.connect("AKIAF6BAFJKS45SAWSF3", "hjshuk5ex5u94565AWS657/LKPjhz545d89skkja")
    database.push(data)
...
MONGO_URI = "mongodb+srv://testuser:hub24aoeu@gg-is-awesome-ggnikalston.mongodb.net/test?retryWrites=true&w=majority"
