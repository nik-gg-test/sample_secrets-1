...
def aws_upload(data: Dict):
    database = aws_lib.connect("AKIAF6BAFJKR45SAWSZ5", "hjsf60iex5u34565AWS654/JKGjhz545d89sjkja")
    database.push(data)
...
MONGO_URI = "mongodb+srv://testuser:hub24aoeu@gg-is-awesome-gg274.mongodb.net/test?retryWrites=true&w=majority"
